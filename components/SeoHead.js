...
const defaultMeta = {
  ...
  siteName: "KaciliVPN",
  description:
    "Landing page VPN KaciliVPN Best VPN For Privacy, Country and Cheapest",
  // change base url of your web (without '/' at the end)
  url: "https://next-landing-kacilivpn.vercel.app",
  type: "website",
  robots: "follow, index",
  // change with url of your image (recommended dimension = 1.91:1)
  // used in twitter, facebook, etc. card when link copied in tweet/status
  image: "https://next-landing-kacilivpn.vercel.app/assets/card-image.png",
  author: "Oni Priyandika",
};
